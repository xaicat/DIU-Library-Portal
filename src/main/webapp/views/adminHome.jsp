...
<head>
    ...
    <title>Admin Home - Modern Shop</title>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="/admin/products" class="btn btn-modern">Manage</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4>Customers</h4>
                                <p>Manage all the customers here.</p>
                                <a href="/admin/customers" class="btn btn-modern">Manage</a>
                            </div>
                        </div>
                    </div>
                </div>
