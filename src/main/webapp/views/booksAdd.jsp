...
<head>
    ...
    <title>Add Books - Diu Library Portal</title>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" readonly="readonly" class="form-control" name="id" value="<%=rs.getInt(1) + 1%>">
                                            <%
                                            }
                                            %>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" required name="price" min="1" placeholder="Price">
                                        </div>
                                        <div class="form-group">
                                            <label for="weight">Weight (grams)</label>
                                            <input type="number" class="form-control" required name="weight" min="1" placeholder="Weight">
                                        </div>
                                        <div class="form-group">
                                            <label for="quantity">Available Quantity</label>
                                            <input type="number" class="form-control" required name="quantity" min="1" placeholder="Quantity">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="description">Book Description</label>
                                            <textarea class="form-control" rows="4" name="description" placeholder="Product Details">no product details</textarea>
                                        </div>
                                        <div class="form-group">
                                            <p>Book Image</p>
                                        ...
                                        <div class="form-group">
                                            <img src="Product Images/one.jpg" alt="Preview" id="imgPreview" height="100px" width="100px" style="margin-top: 20px;">
                                        </div>
                                        <input type="hidden" name="imgName">
                                        <input type="submit" class="btn btn-modern" value="Add Product">
                                    </div>
                                </div>
                            </form>
                        </div>
