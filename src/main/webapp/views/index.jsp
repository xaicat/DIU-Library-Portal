...
<head>
    ...
    <title>Home- Diu Library Portal</title>
        ...
        <div class="container-fostrap">
            <div class="container">
                        ...
                        <div class="product-slider">
                            <div class="slider-grid" id="sliderproduct">
                                <div class="slider-item active">
                                    <img src="https://images.unsplash.com/photo-1519163219899-21d2bb723b3e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80" alt="Burger">
                                    <div class="slider-details">
                                        <h2>Academic Books</h2>
                                        <p>Books are available for rent, Get your hands now!</p>
                                        <div class="rating">
                                            <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i>
                                        </div>
                                        <p class="price">250 Copies Available</p>
                                        <div class="timer">
                                            <span>SWE</span><span>CSE</span><span>MCT</span><span>ITM</span>
                                        </div>
                                        <a href="/user/books" class="btn btn-modern">Rent Now</a>
                                    </div>
                                </div>
                                <div class="slider-item">
                                    <img src="https://images.unsplash.com/photo-1463320726281-696a485928c7?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80" alt="Pizza">
                                    <div class="slider-details">
                                        <h2>Popular Journals</h2>
                                        <p>Recent field works are listed, Explore them Now!</p>
                                        <div class="rating">
                                            <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i>
                                        </div>
                                        <p class="price">75 Copies Available</p>
                                        <div class="timer">
                                            <span>Robotics</span><span>Coding</span><span>CyberSec</span><span>Ai</span>
                                        </div>
                                        <a href="/user/books" class="btn btn-modern">Rent Now</a>
                                    </div>
                                </div>
                                <div class="slider-item">
                                    <img src="https://images.unsplash.com/photo-1476275466078-4007374efbbe?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80" alt="Fruits">
                                    <div class="slider-details">
                                        <h2>Reasearch Papers</h2>
                                        <p>Recent papers on Hands, Start Learning!</p>
                                        <div class="rating">
                                            <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i>
                                        </div>
                                        <p class="price">35 Copies Available</p>
                                        <div class="timer">
                                            <span>CSC</span><span>ML</span><span>Ai</span><span>DBM</span>
                                        </div>
                                        <a href="/user/books" class="btn btn-modern">Rent Now</a>
                                    </div>
                                </div>
                ...
                <div class="row justify-content-center card-grid mt-5">
                    <div class="col-lg-5">
                        <div class="card">
                            <img src="https://i.imgur.com/BQde9wf.jpeg" alt="Best Deals">
                            <div class="card-content">
                                <h4>Books List</h4>
                                <p>Check out our latest books!</p>
                                <a href="/user/books" class="btn btn-modern">Go</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5">
                        <div class="card">
                            <img src="https://i.imgur.com/ayRIKNL.jpeg" alt="Contact Us">
                            <div class="card-content">
                                <h4>Contact Us</h4>
    ...
    <style>
        ...
        * {
        ...
        .slider-grid {
            ...
            gap: 20px;
            overflow: hidden;
            background: rgba(117, 138, 255, 0.096);
