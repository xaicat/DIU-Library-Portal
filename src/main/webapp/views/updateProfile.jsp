...
<head>
    ...
    <title>Update Profile - Diu Library Portal</title>
    ...
    <style>
        ...
        * {
        ...
        .form-section {
            ...
            width: 100%;
            max-width: 600px; /* Adjusted for single-column form */
            margin: 0 auto;
        }
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item"><a class="nav-link" href="/index">Home Page</a></li>
                        ...
                        <div class="form-section">
                            ...
                            <form action="updateuser" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="username" id="firstName" required placeholder="Your Username*" value="${username}" class="form-control form-control-lg">
                                </div>
                                <div class="form-group">
                                    <label for="email">Email Address</label>
                                    <input type="email" class="form-control form-control-lg" required minlength="6" placeholder="Email*" value="${email}" name="email" id="email" aria-describedby="emailHelp">
                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                                </div>
                                <div class="form-group">
                                    <label for="password">Password</label>
                                    <input type="password" class="form-control form-control-lg" required placeholder="Password*" value="${password}" name="password" id="password" 
                                ...
                                <input type="submit" value="Update Profile" class="btn btn-modern btn-block">
                            </form>
                        </div>
                    </div>
                </div>
